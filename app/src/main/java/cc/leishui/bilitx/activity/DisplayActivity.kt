...
class DisplayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myProgressBar = findViewById<ProgressBar>(R.id.myProgressBar)
        //加载进度监听
        ...
        val display_toolbar = findViewById<Toolbar>(R.id.display_toolbar)
        val display_title = findViewById<TextView>(R.id.display_title)
